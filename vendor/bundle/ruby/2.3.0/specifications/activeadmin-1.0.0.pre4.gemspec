# -*- encoding: utf-8 -*-
# stub: activeadmin 1.0.0.pre4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rails>, ["< 5.1", ">= 3.2"])
      s.add_runtime_dependency(%q<ransack>, ["~> 1.3"])
      s.add_runtime_dependency(%q<sass-rails>, [">= 0"])
      s.add_runtime_dependency(%q<sprockets>, ["< 4"])
    else
      ...
      s.add_dependency(%q<rails>, ["< 5.1", ">= 3.2"])
      s.add_dependency(%q<ransack>, ["~> 1.3"])
      s.add_dependency(%q<sass-rails>, [">= 0"])
      s.add_dependency(%q<sprockets>, ["< 4"])
    end
  else
    s.add_dependency(%q<arbre>, [">= 1.0.2", "~> 1.0"])
    s.add_dependency(%q<bourbon>, [">= 0"])
